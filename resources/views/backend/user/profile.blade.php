                        ...
                        <div class="profile card card-body px-3 pt-3 pb-0">
                            <div class="profile-head">
                                ...
                                <div class="profile-info">
                                    ...
                                    <!-- {{ old('zipcode',  isset($profile->zipcode) ? $profile->zipcode : null) }} -->
                                    @if(isset($profile->avatar))
										<img src="{{asset('/upload/'.auth()->user()->id.'/avatar/'.$profile->avatar)}}" class="img-fluid rounded-circle" alt="">
                                    @else
									...
									<div class="profile-details">
										<div class="profile-name px-3 pt-2">
											...
											<p>{{ucfirst(auth()->user()->getRoleNames())}}</p>
										</div>
										<div class="profile-email px-2 pt-2">
											<h4 class="text-muted mb-0"><a href="#" class="__cf_email__" >{{auth()->user()->email}}</a></h4>
											<p>Email</p>
										</div>
                                    ...
                                    <div class="custom-tab-1">
                                        ...
                                        <div class="tab-content">
                                            <div id="my-posts" class="tab-pane fade active show">
                                                ...
                                                <form method="POST" enctype="multipart/form-data" id="post" action="javascript:void(0)" >                                                @csrf
                                                <div class="post-input">

                                                        <textarea name="content" id="textarea" cols="30" rows="5" class="form-control bg-transparent" placeholder="Please type what you want...."></textarea> 
                                                      
                                                        <div>
															<img id="blah" src="" />
														</div>
														<label class="btn btn-primary light px-3">
															<i class="fa fa-link">
                                                                <input type='file'
																	accept=".jpg, .jpeg, .png"
																	class="btn btn-primary light px-3"
																	onchange="readURL(this);"
																	style="display: none;" id="upload" name="image"></i>
														</label>

                                                      
                                                        <!-- <label  class="btn btn-primary light px-3"><i class="fa fa-link">    
                                                              <input type="file" id="upload" name="image" style="display:none"></i> 
                                                            </label> -->

                                                        <!-- <a href="javascript:void()" class="btn btn-primary light mr-1 px-3"><i class="fa fa-camera"></i> </a> -->
                                                  ...
                                                  @foreach($posts as $p)
                                                    ...
                                                    @if(isset($p->image))
                                                        ...
                                                        <img src="{{asset('/upload/'.auth()->user()->id.'/post/'.$p->image)}}" alt="post" class="img-fluid">
                                                    @endif
                                                ...
                                                <div class="profile-personal-info">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6">
															<span><a href="https://fito.dexignzone.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="26435e474b564a4366435e474b564a434a0845494b">[email&#160;protected]</a></span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            ...
                                            <div id="profile-settings" class="tab-pane fade">
                                                <div class="pt-10" style="padding-top:10px">
                                                    <div class="settings-form">
                                                        ...
                                                        <div class="form-group position-relative">
																...
																<input id="add-list" type="text" name=""
																	class="form-control skill-form"  placeholder="Skill">
																<button id="submit"
																	class="submit-btn fa fa-plus-square position-absolute"></button>
															</div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" placeholder="1234 Main St" name="address1" class="form-control" value="{{ old('address1',  isset($profile->address1) ? $profile->address1 : null) }}" >
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Address 2</label>
                                                                <input type="text" name="address2" placeholder="Apartment, studio, or floor" class="form-control" value="{{ old('address2',  isset($profile->address2) ? $profile->address2 : null) }}">
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>City</label>
                                                                    <input type="text" name="city" class="form-control" value="{{ old('city',  isset($profile->city) ? $profile->city : null) }}">
                                                                </div>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                    <label>Country</label>
                                                                    <input type="text" name="country" class="form-control" value="{{ old('country',  isset($profile->country) ? $profile->country : null) }}">
                                                                </div>


                                                            <div class="form-group col-md-6">
                                                                    <label>Zip</label>
                                                                    <input type="text" name="zipcode" class="form-control" value="{{ old('zipcode',  isset($profile->zipcode) ? $profile->zipcode : null) }}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <button class="btn btn-primary upload-image" type="submit"> Update </button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
		...
		function populateList() {
				...
				return `<li>
				<div class="item"><input type="hidden"  name="skill[]" value="${item}">${item}</div><div class="delete">x</div>
			</li>`
			}).join('');
