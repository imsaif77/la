        ...
        ***********************************-->
        <div class="nav-header">
            ...
            <div class="nav-control">
                <div class="hamburger">
                    <span class="line"></span><span class="line">ccx</span><span class="line"></span>
                </div>
            </div>
        </div>
        <!--**********************************
...
<!--**********************************
    ...
    <div class="text-end">
          @if(session('impersonated_by'))
            <a href="{{ route('user.leave-impersonate') }}" class="btn btn-outline-light me-2">Logout session user</a>
          @endif
    </div>
@endauth
</li>
